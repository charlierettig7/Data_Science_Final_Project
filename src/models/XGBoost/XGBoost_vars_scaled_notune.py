...
def load_and_preprocess(file_path_no_vars, file_path_vars):
    ...
    # Impute NAs for gene-level variant count columns
...
def train_model(dtrain, dval, params_path, num_rounds=500, early_stopping_rounds=30):
    ...
    bst.save_model('results/results_vars/XGBoost_results_vars/xgboost_model_vars_scaled_notune.json')
...
def analyze_performance(bst, dtest, y_test, evals_result, feature_names):
    ...
    plt.title('XGBoost RMSE vs. Training Iteration (With Variants, Normalized)')
    plt.grid(True)
    plot_filename = 'results/results_vars/XGBoost_results_vars/xgboost_loss_plot_vars_scaled_notune.png'
    ...
    metrics_filename = 'results/results_vars/XGBoost_results_vars/xgboost_evaluation_metrics_vars_scaled_notune.json'
    ...
    importance_filename = 'results/results_vars/XGBoost_results_vars/xgboost_vars_scaled_notune_feature_importance.txt'
    ...
    ax.set_title(f"XGBoost Top {top_n} Feature Importances (With Variants, Normalized)")
    plt.tight_layout()
    feature_importance_plot_filename = 'results/results_vars/XGBoost_results_vars/xgboost_vars_scaled_notune_feature_importance_plot.png'
