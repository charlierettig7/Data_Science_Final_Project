...
# Fill lingering NAs in gene-level mutation count columns
gene_cols = data_load_vars.columns.difference(data_load_no_vars.columns)
print(gene_cols, flush = True)
...
x = data.drop(columns=[label, 'cellosaurus_id', 'sig_id'])
...
bst.save_model('./results/results_vars/lightGBM_results_vars/lightgbm_vars_scaled_notune_model.txt')
...
plt.title('LightGBM RMSE vs. Training Iteration (With Variants, Normalized)')
plt.grid(True)
plot_filename = './results/results_vars/lightGBM_results_vars/lightgbm_vars_scaled_notune_loss_plot.png'
...
metrics_filename = './results/results_vars/lightGBM_results_vars/lightgbm_vars_scaled_notune_evaluation_metrics.txt'
...
importance_filename = './results/results_vars/lightGBM_results_vars/lightgbm_vars_scaled_notune_feature_importance.txt'
...
ax.set_title(f"LightGBM Top {top_n} Feature Importances (With Variants, Normalized)")
plt.tight_layout()

feature_importance_plot_filename = './results/results_vars/lightGBM_results_vars/lightgbm_vars_scaled_notune_feature_importance_plot.png'
